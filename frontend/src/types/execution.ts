...
export type StreamEvent =
  ...
  | { type: 'llm_end'; model: string; input_preview: string; output_preview: string; token_usage?: TokenUsage; tool_calls?: ToolCall[]; thread_id: string; execution_metrics?: ExecutionMetrics }
  ...
  | { type: 'state_update'; next: string[]; message_count: number; thread_id: string; visited_nodes?: string[]; execution_metrics?: ExecutionMetrics }
